...
public class Fednow_ExecutionsSummary extends BaseClass{

	public String expectedBatchName;
	@Test
	public void FednowBatchExecutionSummaryResults() throws InterruptedException {
		ExtentReport.createTest("Fednow Batch Execution Summary Results");
		...
		clickelementwithname(exectuionpage.fedNowOption, "Fednow select from list");


		expectedBatchName = prop.getProperty("FednowBatchName");
